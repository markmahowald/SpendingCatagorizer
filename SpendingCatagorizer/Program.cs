...
class Program
{
    static void Main(string[] args)
    {
        ...
        var categories = new Dictionary<string, string[]>
        {
            ...
            {"S ara Business", new[] {"DEPOSIT ACH MEND AND BEND", "TIFFANY BUCKNAM", "DEPOSIT ACH VENMO ", "DEPOSIT BY CHECK MDC MDC HOLD", "YOGA CENTER OF DENVER", "NAYAX", "SAMAMKAYA ", "AKASHA ", "SARA LUCHIN", "SARA MAHOWALD", "LIVING YOGA", "ZOOM.US", "VENMO CASHOUT"}},
